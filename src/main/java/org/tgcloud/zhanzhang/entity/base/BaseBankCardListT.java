...
public abstract class BaseBankCardListT<M extends BaseBankCardListT<M>> extends Model<M> implements IBean {
	...
	public void setTUserId(java.lang.Integer TUserId) {
		set("TUserId", TUserId);
	}
