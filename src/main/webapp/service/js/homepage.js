...
+ function($) {
    ...
    homepage.config = {
         ...
         searchDefault: baseUrl + '/user/searchDefault',
         notice: baseUrl + '/user/notice/noticeList',
...
$(function () {
  'use strict';
    ...
    var viewSR =  function(data) {
         ...
         for (var key in data) {
             ...
             if(key=='hotsearch'){
                  var valuehot = $.trim(data[key]);
                  var hotsearchvalue = valuehot.substring(0,valuehot.length-1).split(",");
                  console.info(valuehot.substring(0,valuehot.length-1))
                  var listhot = $('#hotsearch');
                  if(hotsearchvalue && hotsearchvalue.length > 0 && hotsearchvalue[0] != ''){
                          $.each(hotsearchvalue, function(i, e) {
                                 htmlhot.push('<div class="col-33"><p><a href="#" class="button button-round hotlinestyle" onclick="hotword(', "this)", '">' + e + '</a></p></div>')
                         });
                    if (htmlhot.length > 0) {
                   listhot.html(htmlhot.join(''));
                    }
                  }
             ...
             if(key=='hissearch'){
                  var valuehis = $.trim(data[key]);
                  var hissearchvalue = valuehis.substring(0,valuehis.length-1).split(',');
                  var listhis = $('#hissearch');
                  if(hissearchvalue && hissearchvalue.length > 0 && hissearchvalue[0] != ''){
                          $.each(hissearchvalue, function(i, e) {
                                 htmlhis.push('<div class="col-33"><p><a href="#" class="button button-round hotlinestyle" onclick="hisword(', "this)", '">' + e + '</a></p></div>')
                         });
                     
                     if (htmlhis.length > 0) {
                   listhis.html(htmlhis.join(''));
                    }  
                  }
        ...
        var viewNotice =  function(data) {
                var html=[];
         for (var key in data) {
         
            
                  var valuetitle = $.trim(data[key].title);
             

                  var listtitle = $('#jsfoot01');
                    // htmltitle.push(valuetitle);
                    html.push('<li><a href="" target="_blank">'+valuetitle+'</a></li>');
 
              if (listtitle) {
               listtitle.html(html.join(''));
                }
  ...
  homepage.index = {
        ...
        notice:function(id) {
            ...
            homepage.tool.ajax(homepage.config.notice, data, null, 'post', function(d) {
       ...
       query: function(obj) {
         ...
         if(1 == data.types){
              ...
              homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#jingquList").html(homepage.config.constant['0012']);
                } else if (d) {
                    console.info(d)
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#peiyouList").html(homepage.config.constant['0012']);
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                     $("#bianminfuwuList").html(homepage.config.constant['0012']);
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#bianminxuqiuList").html(homepage.config.constant['0012']);
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#zhenghuiList").html(homepage.config.constant['0012']);
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#zhaogongzuoList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                     $("#zhaopingList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#nonginyumuList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#aixinList").html(homepage.config.constant['0012']);
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#bendiqiyeList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#benditecanList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                   $("#tongzhiList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#baominList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#fanguiList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#qiuzhengList").html(homepage.config.constant['0012']);
                } else if (d) {
               ...
               homepage.tool.ajax(homepage.config.AllList, data, null, 'post', function(d) {
                ...
                if (d.data && homepage.config.constant['0003'] == d.data) {
                    ...
                    $("#qiuzhengList").empty();
                    $("#zhengqiuList").empty();
                    $("#zhengqiuList").html(homepage.config.constant['0012']);
                } else if (d) {
        ...
        hotsearch:function() {
            ...
            homepage.tool.ajax(homepage.config.searchDefault, null, null, 'post', function(d) {
    ...
    $(document).on("pageInit", function(e, pageId, $page) {
            ...
            if (pageId == "pageIndex" ) {
                ...
                //javascript:login.save(user_id,username)
    ...
    $("#btnSearch").click(function() {
            ...
            $("#contentPadded").css("display","none");
            $(".tab_title").css("display","block");
            $(".mobanlist").css("display","block");
            
            
        });
     $("#tiaosearch").click(function() {
            homepage.index.hotsearch();
        });
...
function  hotword(e){
     var $star = $(e);
     console.info($star.text())
      
         $("#searchnamelist").val($star.text());
           $("#contentPadded").css("display","none");
            $(".tab_title").css("display","block");
            $(".mobanlist").css("display","block");
             homepage.index.query(1);
