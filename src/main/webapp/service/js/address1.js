...
//省、市、区
var provincePosdatas=[];
var cityPosdatas=[];
var district=[]
function _cityPosdata(obj,obj2,obj3){
    console.info(obj,obj2,obj3)
    for (var i = 0; i < province_enum.length; i++) {
        if (province_enum[i].name === obj ){
            provincePosdatas[0]=province_enum[i].id;
            provincePosdatas[1]=province_enum[i].name;
        }
        for(var j = 0; j < province_enum[i].city.length; j++) {
            ...
            if ( province_enum[i].city[j].name === obj2){
                ...
                for(var k = 0; k < province_enum[i].city[j].district.length; k++) {

                    if (province_enum[i].city[j].district[k].name === obj3) {
                        district[0] = province_enum[i].city[j].district[k].id;
                        district[1] = province_enum[i].city[j].district[k].name;
...
function _cityPosdataPub(obj,obj2,obj3){
    console.info(obj,obj2,obj3)
         for (var i = 0; i < province_enum.length; i++) {
            if (province_enum[i].name === obj ){
            pubprovincePosdatas[0]=province_enum[i].id;
            pubprovincePosdatas[1]=province_enum[i].name;
          }
            for(var j = 0; j < province_enum[i].city.length; j++) {

            if ( province_enum[i].city[j].name === obj2){
            pubcityPosdatas[0]=province_enum[i].city[j].id;
            pubcityPosdatas[1]=province_enum[i].city[j].name;
                for(var k = 0; k < province_enum[i].city[j].district.length; k++) {
     ...
     var p_id=pubprovincePosdatas[0];
     var c_id=pubcityPosdatas[0];
     var d_id=district[0];
      pubget(p_id,c_id,d_id);
...
var region_initx = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {
    ...
    // if (_region_d !== null || _region_d !== undefined || _region_d !== '') {
    //         var region_d = document.getElementById(_region_d);
    //      }
...
var map_init = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {
    var region_p = document.getElementById(_region_p);
    var region_c = document.getElementById(_region_c);
    var region_d = document.getElementById(_region_d);
    ...
    function region_d_change() {
        ...
        map.centerAndZoom(region_d.options[region_d.options.selectedIndex].text, 12);

        geoc.getPoint(region_d.options[region_d.options.selectedIndex].text, function(point){
            if (point) {
        ...
        }, region_p.options[region_p.options.selectedIndex].text);
...
var region_inity = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {
     var region_p = document.getElementById(_region_p);
     var region_c = document.getElementById(_region_c);
     var region_d = document.getElementById(_region_d);
...
var region_init = function (_region_p, _region_c, _region_d,  _region_p_default, _region_c_default, _region_d_default) {
    ...
    //function region_d_change() {
        ...
        //if (location.hash==""||location.hash=="#pageIndex"){
        //    if(window.filedate==window.homepage){
        //        filedate.index.initfirst('01');
        //        filedate.index.initsecond('02');
        //        filedate.index.notice(1);
        //    }
            //else if(window.filedate==window.zhanzhang){
            //    filedate.index.query();
            //    filedate.index.init(7);
            //}else if(window.marriage==window.filedate){
            //    filedate.joblist.query2();
            //    filedate.joblist.init(9);
            //}else if (window.agriculture==window.filedate){
            //    filedate.index.query();
            //    filedate.index.init(13);
            //}
            //else if (window.enterprise==window.filedate){
            //    filedate.index.query();
            //    filedate.index.init(15);
            //}
            //else if(window.filedate==window.love){
            //    filedate.index.query();
            //    filedate.index.init(14);
            //}else if(window.filedate==window.notice){
            //    filedate.index.query();
            //    filedate.index.init(11);
            //}else if ( window.tourism==window.filedate){
            //    filedate.index.query();
            //    filedate.index.init(18);
            //}
    ...
    function region_c_change() {
        ...
        // if(region_c.options[0].innerHTML=="市辖区"){
        //  var map = new BMap.Map('MyMap');
        //  map.centerAndZoom(region_p.options[region_p.options.selectedIndex].text, 12);
        // }
        // if(region_c.className=="city_map" && region_c.options[0].innerHTML!="市辖区"){
        //  var map = new BMap.Map('MyMap');
