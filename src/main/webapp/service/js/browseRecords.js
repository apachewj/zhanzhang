...
+ function($) {
    ...
    publish.config = {
        ...
        clickList:baseUrl + '/user/click_List',
        deleteClick:baseUrl + '/user/Click_Delete',
        clickDeleteAll:baseUrl + '/user/Click_Delete_All',
                    ...
                    '<a href="../service/tourism.html?id=${item.id}#pageScenicDetail" external class="item-link item-content">',
                      ...
                      '</div>',
                       '</a>',
                        ...
                        '<div class="delete" onclick="delPub(', "'${item.types}','${item.clickid}')", '">删&nbsp;除</div>',
   ...
   publish.index = {
       ...
       query: function() {
          ...
          if(1 == data.types){
              ...
              publish.tool.ajax(publish.config.clickList, data, null, 'post', function(d) {
                if (debug) {
                    console.log(d);
                }
                if (d.data && publish.config.constant['0003'] == d.data) {
  ...
  publish.index.query(1);
    ...
    $.init();
        ...
        $("#clearall").click(function() {
              $.confirm('您确定要清空所有浏览记录吗?', function() {
         
                  publish.tool.ajax(publish.config.clickDeleteAll, null, null, 'post', function(d) {
...
function delPub(types, id) {
    $.confirm('您确定要删除该信息吗?', function() {
        ...
        publish.tool.ajax(publish.config.deleteClick, data, null, 'post', function(d) {
    ...
    $(document).on('infinite', function() {
       ...
       var pageNum = $("#rent_pageNum").val();
        ...
        setTimeout(function() {
            ...
            param.PageSize = 10;
            publish.tool.ajax(publish.config.clickList, param, null, 'post', function(d) {
                if (debug) {
                    console.log(d);
                };
                if (d.data && publish.config.constant['0003'] == d.data) {
