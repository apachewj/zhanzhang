...
function _cityPosdata(province,city){
         for (var i = 0; i < province_enum.length; i++) {
            if (province_enum[i].name === province ){
            ...
            if ( province_enum[i].city[j].name === city){
     ...
     get(p_id,c_id);
        ...
        // if (window.tourism==window.filedate){
    	   //     filedate.index.query(cityPosdatas[0]);
        // }else if (window.zhanzhang==window.filedate){
        //        filedate.index.query(cityPosdatas[0]);
        // }else if (window.agriculture==window.filedate){
        //        filedate.index.query(cityPosdatas[0]);
        // }else if (window.enterprise==window.filedate){
        //        filedate.index.query(cityPosdatas[0]);
        // }else if(window.filedate==window.speciality){ 
        //        filedate.MyEnterpriseDetail.query( null ,cityPosdatas[0]);
...
var region_init = function (_region_p, _region_c, _region_d,  _region_p_default, _region_c_default, _region_d_default) {
    ...
    function region_c_change() {
        ...
        if (window.zhanzhang==window.filedate&&location.hash!="#pagePeopleServiceDetail"&&location.hash!="#pagePeopleNeedDetail"
           ){
               filedate.index.query();
        
        }else if ( window.tourism==window.filedate&&location.hash!="#pageScenicDetail"&&location.hash!="#pageyoudetailes"){
               filedate.index.query();
        }
        else if (window.agriculture==window.filedate){
               filedate.index.query();
               ...
               filedate.index.query();
        }else if(window.filedate==window.speciality&&location.hash!="#pageSpecialityDetail"){ 
               filedate.MyEnterpriseDetail.query();
        }else if(window.filedate==window.love&&location.hash!="#pagelovedetails"){ 
                filedate.index.query(); 
        }else if(window.filedate==window.notice&&location.hash!="#pagenoticedetails"&&location.hash!="#pageconfirmdetails"&&location.hash!="#pageseekdetails"&&location.hash!="#pagefeedbackdetails"&&location.hash!="#pageenrolldetails"){ 
                filedate.index.query();
        }
