(function() {
    ...
    window.AmCharts ? d = window.AmCharts: (d = {},
        ...
        d.maps = {},
        d.inheriting = {},
        d.charts = [], d.onReadyArray = [], d.useUTC = !1, d.updateRate = 60, d.uid = 0, d.lang = {},
        d.translations = {},
        d.mapTranslations = {},
        d.windows = {},
        d.initHandlers = [], d.amString = "am", d.pmString = "pm");
    d.Class = function(a) {
        var b = function() {
    ...
    d.handleWheel = function(a) {
        for (var b = d.charts,
                 c = 0; c < b.length; c++) {
            var e = b[c];
            if (e && e.mouseIsOver) { (e.mouseWheelScrollEnabled || e.mouseWheelZoomEnabled) && e.handleWheel && e.handleWheel(a);
                break
            }
        }
    };
    ...
    d.getStyle = function(a, b) {
        ...
        } catch(e) {} else a.currentStyle && (b = b.replace(/\-(\w)/g,
            function(a, b) {
    ...
    d.formatDuration = function(a, b, c, e, h, f) {
        ...
        c = a + "" + e[b] + "" + c;
        if (g[h].count > g[b].count) for (a = g[b].count; a < g[h].count; a++) b = g[b].nextInterval,
    ...
    d.processObject = function(a, b, c, e) {
        if (!1 === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), !0), a.listeners)) for (var h in a.listeners) b = a.listeners[h],
    ...
    d.parseDefs = function(a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var h = 0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c),
                b.appendChild(e),
                d.parseDefs(a[c][h], e);
    ...
    d.AxisBase = d.Class({
        ...
        addGuide: function(a) {
            for (var b = this.guides,
                     c = !1,
                     e = b.length,
                     h = 0; h < b.length; h++) b[h] == a && (c = !0, e = h);
        ...
        parseDatesDraw: function() {
            ...
            if (g == A && 1 == u && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = z * this.stepWidth,
            ...
            var C = 0,
                K = 0;
            a && 1 < u && (v = this.chooseMinorFrequency(u), x = d.getPeriodDuration(A, v), "DD" == A && (x += d.getPeriodDuration("hh")), "fff" == A && (x = 1));
            if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                "MM" == A && (h = (p - l) / z, 1.5 <= (p - l) / z && (p = p - (h - 1) * z + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p), A, 1).getTime(), C += z));
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(v)) for (h = 1; h < u; h += v) this.gridAlpha = this.minorGridAlpha,
                    f = p + x * h,
                    f = d.resetDateToMin(new Date(f), A, v, t).getTime(),
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function() {
            ...
            var c = this.type;
            "duration" == c && (this.duration = "ss"); ! 0 === this.dataChanged && (this.updateData(), this.dataChanged = !1);
            ...
            if (this.logarithmic) {
                var e = this.treatZeroAs,
                    h = this.getExtremes(0, this.data.length - 1).min; ! isNaN(this.minimum) && this.minimum < h && (h = this.minimum);
                this.logMin = h;
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                } else this.relativeStart = d.fitToBounds((this.min - this.fullMin) / (this.fullMax - this.fullMin), 0, 1),
                ...
                this.exponential = !1;
                for (g = t; g < r; g += p) {
                    var A = d.roundTo(this.step * g + this.min, y); - 1 != String(A).indexOf("e") && (this.exponential = !0)
                }
                ...
                if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(),
                    ...
                    this.parseDatesDraw();
                else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, h && (r++, c = this.maxCalc - r * y), this.gridCountReal = r, g = this.startCount = t; g < r; g += p) if (t = y * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t) if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
                        if (!0 === h) if (v > this.logGridLimit) t = Math.pow(10, g);
                        else if (0 >= t && (t = c + y * g + y / 2, 0 >= t)) continue;
                        ...
                        if (!isNaN(z) && 0 < A && g < r - 1) {
                            f = y / z;
                            h && (z = y * (g + p) + this.minCalc, z = d.roundTo(z, this.maxDecCount + 1), v > this.logGridLimit && (z = Math.pow(10, g + p)), f = 9, z = (z - t) / f);
                            K = this.gridAlpha;
                            this.gridAlpha = this.minorGridAlpha;
                            for (H = 1; H < f; H++) {
                                var P = this.getCoordinate(t + z * H),
                                    P = new this.axisItemRenderer(this, P, "", !1, 0, 0, !1, !1, 0, !0);
                                this.pushAxisItem(P)
                            }
                            this.gridAlpha = K
                        }
                ...
                if (0 < B) {
                    D = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < B; g++) C = v[g],
                        k = NaN,
                        z = C.above,
                    isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), u = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(u, z)),
                        l = NaN,
                    isNaN(C.value) || (l = this.getCoordinate(C.value), u = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(u, z)),
                    isNaN(k) && (l -= 3, k = l + 3),
                    C.balloonText && u && (m = u.label) && this.addEventListeners(m, C),
                    isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, z), z = k.graphics(), C.graphics = z, C.balloonText && this.addEventListeners(z, C));
                    this.fillAlpha = D
                }
                u = this.baseValue;
            ...
            this.positionTitle();
            "radar" != a.type && h.toFront(); ! this.visible || e ? (b.hide(), h.hide(), u.hide()) : (b.show(), h.show(), u.show());
            this.axisY = this.y;
            this.axisX = this.x
        },
        ...
        formatValue: function(a, b, c) {
            ...
            this.usePrefixes && (e = !1),
                e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c = Number(e[0]), e = Number(e[1]), c = d.roundTo(c, 14), b || isNaN(this.precision) || (c = d.roundTo(c, this.precision)), 10 == c && (c = 1, e += 1), c = c + "e" + e, 0 === a && (c = "0"), 1 == a && (c = "1")) : (h && (e = String(a).split("."), e[1] ? (f.precision = e[1].length, 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision = 0), b || isNaN(this.precision) || (f.precision = this.precision)) : f.precision = -1), c = this.usePrefixes ? d.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : d.formatNumber(a, f, f.precision)),
        ...
        stackGraphs: function(a) {
            ...
            for (p = n; p <= l; p++) {
                var v = 0;
                for (q = 0; q < k.length; q++) if (n = k[q], n.hidden) n.newStack && (h[p] = NaN, e[p] = NaN);
                else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[p] = NaN, e[p] = NaN);
                else {
        ...
        getCoordinate: function(a, b) {
            ...
            var c = this.rotate,
                ...
                f = this.stepWidth,
                g = this.min,
                k = this.minReal; ! 0 === this.logarithmic ? (0 === a && (a = this.treatZeroAs), g = Math.log(a) * Math.LOG10E - Math.log(k) * Math.LOG10E, c = c ? !0 === e ? d - f * g: f * g: !0 === e ? f * g: d - f * g) : c = !0 === e ? c ? d - f * (a - g) : f * (a - g) : c ? f * (a - g) : d - f * (a - g);
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            "V" == Pa && (n = 0);
            var ca;
            R && "" !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(y, c, v, t, r, ga, k, Math.abs(h), 0) : d.text(y, c, v, t, r, ga, k), ga = ca.getBBox(), ha = ga.width, Qa = ga.height);
            if ("H" == Pa) {
                if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [b, b + wa, b + wa], [X, X + ma, ma], K, D, C, H), x.push(Ba))), w = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", w = "bottom" == Z ? I ? w + B: w - B: I ? w - B: w + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(y, Y, a.height, P, O), Da.translate(e - Y + wa, ma), x.push(Da))), "bottom" == Z ? (w += X + r / 2 + ea, I ? (0 < n ? (w = X - ha / 2 * Math.sin(V) - B - 3, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)) : 0 > n ? (w = X + ha * Math.sin(V) - B - 3 + 2, G += -ha * Math.cos(V) - Qa * Math.sin(V) - 4) : w -= B + r + 3 + 3, w -= aa) : (0 < n ? (w = X + ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : 0 > n ? (w = X + B + 3 - ha / 2 * Math.sin(V) + 2, G += ha / 2 * Math.cos(V)) : w += B + u + 3 + 3, w += aa)) : (w += ma + r / 2 - ea, G += wa, I ? (0 < n ? (w = ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : w += B + 3, w += aa) : (0 < n ? (w = -(ha / 2) * Math.sin(V) - B - 6, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V))) : w -= B + r + 3 + u + 3, w -= aa)), "bottom" == Z ? Y = (I ? X - B - 1 : X + u - 1) + ea: (na = wa, Y = (I ? ma: ma - B - u + 1) - ea), f && (G += f), r = G, 0 < n && (r += ha / 2 * Math.cos(V)), ca && (f = 0, I && (f = ha / 2 * Math.cos(V)), r + f > Aa + 2 || 0 > r)) ca.remove(),
                    ca = null
            } else {
                0 <= b && b <= X + 1 && (0 < B && 0 < z && b + l <= X + 1 && (fa = d.line(y, [0, B + 1], [b + l, b + l], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [0, wa, Aa + wa], [b, b + ma, b + ma], K, D, C, H), x.push(Ba)));
                ga = "end";
                if (!0 === I && "left" == Z || !1 === I && "right" == Z) ga = "start";
                w = b - Qa / 2 + 2;
                1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), V = e - da, Da = d.polygon(y, [0, a.width, a.width, 0], [0, 0, V, V], P, O), Da.translate(wa, e - V + ma), x.push(Da));
                w += r / 2;
                "right" == Z ? (G += wa + Aa + ea, w += ma, I ? (f || (w -= r / 2 + 3), G = G - (B + 4) - aa) : (G += B + 4 + u, w -= 2, G += aa)) : I ? (G += B + 4 - ea, f || (w -= r / 2 + 3), g && (G += wa, w += ma), G += aa) : (G += -B - u - 4 - 2 - ea, w -= 2, G -= aa);
                fa && ("right" == Z ? (na += wa + ea + Aa - 1, Y += ma, na = I ? na - u: na + u) : (na -= ea, I || (na -= B + u)));
                f && (w += f);
                I = -3;
                "right" == Z && (I += ma);
                ca && (w > X + 1 || w < I - r / 10) && (ca.remove(), ca = null)
            }
            fa && (fa.translate(na, Y), d.setCN(p, fa, a.bcn + "tick"), d.setCN(p, fa, q, !0), g && d.setCN(p, fa, "guide")); ! 1 === a.visible && (fa && fa.remove(), ca && (ca.remove(), ca = null));
            ca && (ca.attr({
                "text-anchor": ga
            }), ca.translate(G, w, NaN, !0), 0 !== n && ca.rotate( - n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, !0), g && d.setCN(p, ca, "guide"));
    ...
    d.AmChart = d.Class({
        ...
        drawBackground: function() {
            ...
            this.background = b;
            e.push(b);
            if (b = this.backgroundImage) a = a.image(b, 0, 0, h, f),
        ...
        afterWrite: function(a) {
            ...
            if (b = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                b.appendChild(k); (b = this.exportConfig) && d.AmExport && !this.AmExport && (this.AmExport = new d.AmExport(this, b));
        ...
        addListeners: function() {
            ...
            document.addEventListener ? ("ontouchstart" in document.documentElement && (b.addEventListener("touchstart",
                ...
                document.addEventListener("touchstart", a.docfn1, !0), document.addEventListener("touchend", a.docfn2, !0)), b.addEventListener("mousedown",
                function(b) {
                    a.mouseIsOver = !0;
                    a.handleMouseMove.call(a, b);
        ...
        handleResize: function() { (d.isPercents(this.width) || d.isPercents(this.height)) && this.invalidateSizeReal();
            this.renderFix()
        },
        renderFix: function() {
            if (!d.VML) {
        ...
        updateAnimations: function() {
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                } else h.node.style[f] = Number(b.to) + b.suffix,
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    c.push(t);
                    if (!isNaN(p)) {
                        var v = this.valueAxis.getCoordinate(p, this.noRounding) - this.height,
                            v = v * this.valueAxis.rMultiplier,
                            y = v * Math.sin(r / 180 * Math.PI),
                            r = v * Math.cos(r / 180 * Math.PI);
                        e.push(y);
                        d.push(r);
                        isNaN(k) && (k = y);
                        isNaN(l) && (l = r)
                    ...
                    n.x = q;
                    n.y = t;
                    if (y = this.labelText) y = this.createLabel(n, y),
                        v = 0,
                    r && (v = r.size),
                        this.positionLabel(n, q, t, y, v);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
            ...
            if (e) {
                ...
                switch (m) {
                    ...
                    case "left":
                        ...
                        break;
                    case "inside":
                        "column" == this.type && (l = !0, q ? p ? (k = "end", b = r - 3 - y) : (k = "start", b = r + 3 + y) : c = p ? v + 7 + y: v - 10 - y);
                        break;
                    case "middle":
                        "column" == this.type && (l = !0, q ? b -= (b - r) / 2 + y - 3 : c -= (c - v) / 2 + y - 3)
                }
                ...
                e.translate(b, c); ! this.showAllValueLabels && t && l && (n = e.getBBox(), n.height > a.columnHeight || n.width > a.columnWidth) && (e.remove(), e = null);
                if (e && "radar" != f.type) if (q) {
                    if (0 > c || c > this.height) e.remove(),
                        e = null; ! this.showAllValueLabels && (0 > b || b > this.width) && (e.remove(), e = null)
                } else {
        ...
        createSerialGraph: function() {
            ...
            var m = this.useNegativeColorIfDown,
                ...
                t = this.rotate,
                r = this.columnCount,
                v = d.toCoordinate(this.cornerRadiusTop, k / 2),
                y = this.connect,
                x = [],
                u = [],
                A,
            ...
            if (! (I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ra && void 0 == Ja || m))) {
                ...
                t ? (ha = q, Qa = Math.abs(Mb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb = 0, f.reversed ? (ca = 0, gb = Ka) : (ca = Ka, gb = 0)) : (Qa = n, ha = Math.abs(Mb - Ka), vb = n, ub = Math.abs(ib - Ka), gb = ca = 0, f.reversed ? (hb = p, tb = Ka) : hb = Ka)
            }
            var La = Math.round;
            this.pmx = La(ca);
            this.pmy = La(tb);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < R) {
                    for (L = R - 1; - 1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], na = w.values.value, !isNaN(na)) {
                        R = L;
                        break
                    }
                    if (this.lineColorField) for (L = R; - 1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], w.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched = w.lineColor;
                        break
                    }
                    if (this.fillColorsField) for (L = R; - 1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], w.fillColors) {
                        this.fillColorsSwitched = w.fillColors;
                        break
                    }
                    if (this.dashLengthField) for (L = R; - 1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], !isNaN(w.dashLength)) {
            ...
            var T = [],
                U = [],
                Ma = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == O || "100%" == O || this.fillToGraph) Ma = !0;
            ...
            for (L = R; L <= ia; L++) {
                ...
                isNaN(w.dashLength) || (ea = w.dashLength);
                var Ia = w.values;
                f.recalculateToPercents && (Ia = w.percents);
                "none" == O && (Z = isNaN(w.columnIndex) ? this.columnIndex: w.columnIndex);
                if (Ia) {
                    W = this.stackable && "none" != O && "3d" != O ? Ia.close: Ia.value;
                    if ("candlestick" == g || "ohlc" == g) W = Ia.close,
                        Ab = Ia.low,
                        qa = f.getCoordinate(Ab),
                        zb = Ia.high,
                        sa = f.getCoordinate(zb);
                    ta = Ia.open;
                    ...
                    var va = Math.floor(Y / 2) + Math.floor(Wa * Y / 2),
                        Ga = va,
                        nb = 0;
                    "left" == this.stepDirection && (nb = (2 * Y + Wa * Y) / 2, ja -= nb);
                    "center" == this.stepDirection && (nb = Y / 2, ja -= nb);
                    "start" == this.pointPosition && (ja -= Y / 2 + Math.floor(Wa * Y / 2), va = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    "end" == this.pointPosition && (ja += Y / 2 + Math.floor(Wa * Y / 2), va = Math.floor(Y) + Math.floor(Wa * Y), Ga = 0);
                    if (Ob) {
                        var Cb = this.columnWidth;
                        isNaN(Cb) || (va *= Cb, Ga *= Cb)
                    }
                    I || (w.x = ja); - 1E5 > ja && (ja = -1E5);
                    ja > n + 1E5 && (ja = n + 1E5);
                    t ? (E = F, N = M, M = F = ja, isNaN(ta) && !this.fillToGraph && (N = ma), pa = qa, ra = sa) : (N = E = ja, isNaN(ta) && !this.fillToGraph && (M = ma));
                    if (!Bb && W < ta || Bb && W < Ba) w.isNegative = !0,
                    Ra && (Na = Ra),
                    Za && (Va = Za),
                    void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    isNaN(W) || (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : w.isNegative = W < Pa ? !0 : !1, Ba = W);
                    var Pb = !1;
                    I && a.chartScrollbar.ignoreCustomColors && (Pb = !0);
                    Pb || (void 0 != w.color && (Na = w.color), w.fillColors && (Na = w.fillColors));
                    F = d.fitToBounds(F, -3E4, 3E4);
                    switch (g) {
                        case "line":
                            if (isNaN(W)) y || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []);
                            else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) x.push(E),
                                    u.push(F),
                                    jb = E,
                                    kb = F;
                                xa = E;
                                Ea = F;
                                ka = E;
                                la = F; ! Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M));
                                if ($a || void 0 != w.lineColor && w.lineColor != this.lineColorSwitched || void 0 != w.fillColors && w.fillColors != this.fillColorsSwitched || !isNaN(w.dashLength)) this.drawLineGraph(x, u, T, U),
                                    x = [E],
                                    u = [F],
                                    T = [],
                                    U = [],
                                !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)),
                                    m ? Sa ? (this.lineColorSwitched = Aa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Ra) : (this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors),
                                    this.dashLengthSwitched = w.dashLength;
                                w.gap && (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = [])
                            }
                            break;
                        case "smoothedLine":
                            if (isNaN(W)) y || (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = []);
                                ...
                                ka = E;
                                la = F; ! Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M));
                                void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(x, u, T, U), x = [E], u = [F], T = [], U = [], !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)), this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors, this.dashLengthSwitched = w.dashLength);
                                w.gap && (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = [])
                            }
                            break;
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (x.push(A), u.push(F - va)), u.push(F - va), x.push(E), u.push(F + Ga), x.push(E), !Ma || isNaN(M) || isNaN(N) || (isNaN(B) || (T.push(B), U.push(M - va)), T.push(N), U.push(M - va), T.push(N), U.push(M + Ga))) : (isNaN(z) || (u.push(z), x.push(E - va)), x.push(E - va), u.push(F), x.push(E + Ga), u.push(F), !Ma || isNaN(M) || isNaN(N) || (isNaN(D) || (T.push(N - va), U.push(D)), T.push(N - va), U.push(M), T.push(N + Ga), U.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                D = M;
                                ...
                                ka = E;
                                la = F;
                                if ($a || void 0 != w.lineColor || void 0 != w.fillColors || !isNaN(w.dashLength)) {
                                    var Db = x[x.length - 2],
                                        dc = u[u.length - 2];
                                    x.pop();
                                    u.pop();
                                    ...
                                    T = [];
                                    U = [];
                                    Ma && (T = [Db, Db + va + Ga], U = [D, D]);
                                    t ? (u.push(F + Ga), x.push(E)) : (x.push(E + Ga), u.push(F));
                                    this.lineColorSwitched = w.lineColor;
                                    this.fillColorsSwitched = w.fillColors;
                                    this.dashLengthSwitched = w.dashLength;
                                    m && (Sa ? (this.lineColorSwitched = Aa, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Ra))
                                }
                                if (Ob || w.gap) A = z = NaN,
                                    this.drawLineGraph(x, u, T, U),
                                    x = [],
                                ...
                                if (1 >= this.periodSpan || 1 < this.periodSpan && E - A > va + Ga) A = z = NaN;
                                this.drawLineGraph(x, u, T, U);
                                x = [];
                                u = [];
                                T = [];
                        ...
                        case "column":
                            Ca = Ha;
                            void 0 != w.lineColor && (Ca = w.lineColor);
                            if (!isNaN(W)) {
                                m || (w.isNegative = W < Pa ? !0 : !1);
                                w.isNegative && (Ra && (Na = Ra), void 0 != Ja && (Ca = Ja));
                                var Qb = f.min,
                                    Rb = f.max,
                                    ob = ta;
                                isNaN(ob) && (ob = Pa);
                                if (! (W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                    var za;
                                    if (t) {
                                        "3d" == O ? (Q = F - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + P * Z, S = N + H * Z, za = Z) : (Q = Math.floor(F - (r / 2 - Z) * (k + V) + V / 2), S = N, za = 0);
                                        J = k;
                                        xa = E;
                                        Ea = Q + k / 2;
                                        ka = E;
                                        la = Q + k / 2;
                                        Q + J > q + za * P && (J = q - Q + za * P);
                                        Q < za * P && (J += Q, Q = za * P);
                                        ba = E - N;
                                        var ec = S;
                                        ...
                                        w.labelIsNegative = 0 > ba ? !0 : !1;
                                        0 === ba && 1 / W === 1 / -0 && (w.labelIsNegative = !0);
                                        isNaN(G.percentWidthValue) || (J = this.height * G.percentWidthValue / 100, Q = ja - J / 2, Ea = Q + J / 2);
                                        J = d.roundTo(J, 2);
                                        ba = d.roundTo(ba, 2);
                                        Q < q && 0 < J && (ua = new d.Cuboid(h, ba, J, H - a.d3x, P - a.d3y, Na, Va, da, Ca, X, ga, v, t, ea, bb, mb, aa), w.columnWidth = Math.abs(ba), w.columnHeight = Math.abs(J))
                                    } else {
                                        "3d" == O ? (S = E - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + H * Z, Q = M + P * Z, za = Z) : (S = E - (r / 2 - Z) * (k + V) + V / 2, Q = M, za = 0);
                                        J = k;
                                        xa = S + k / 2;
                                        Ea = F;
                                        ka = S + k / 2;
                                        la = F;
                                        S + J > n + za * H && (J = n - S + za * H);
                                        S < za * H && (J += S - za * H, S = za * H);
                                        ba = F - M;
                                        w.labelIsNegative = 0 < ba ? !0 : !1;
                                        0 === ba && 1 / W !== 1 / Math.abs(W) && (w.labelIsNegative = !0);
                                        var fc = Q;
                                        Q = d.fitToBounds(Q, this.dy, q);
                                        ba += fc - Q;
                                        ba = d.fitToBounds(ba, -Q + P * za, q - Q);
                                        isNaN(G.percentWidthValue) || (J = this.width * G.percentWidthValue / 100, S = ja - J / 2, xa = S + J / 2);
                                        J = d.roundTo(J, 2);
                                        ba = d.roundTo(ba, 2);
                                        S < n + Z * H && 0 < J && (this.showOnAxis && (Q -= P / 2), ua = new d.Cuboid(h, J, ba, H - a.d3x, P - a.d3y, Na, Va, da, Ca, this.lineAlpha, ga, v, t, ea, bb, mb, aa), w.columnHeight = Math.abs(ba), w.columnWidth = Math.abs(J))
                                    }
                                }
                                if (ua) {
                                    ya = ua.set;
                                    ...
                                    S = d.roundTo(S, 2);
                                    Q = d.roundTo(Q, 2);
                                    ya.translate(S, Q); (w.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer");
                                    if (!I) {
                                        "none" == O && (K = t ? (this.end + 1 - L) * C - c: C * L + c);
                                        "3d" == O && (t ? (K = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, xa += H * Z, ka += H * Z, w.y += H * Z) : (K = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += P * Z, la += P * Z, w.y += P * Z));
                                        if ("regular" == O || "100%" == O) K = t ? 0 < Ia.value ? (this.end + 1 - L) * C + c: (this.end + 1 - L) * C - c: 0 < Ia.value ? C * L + c: C * L - c;
                                        ...
                                        this.addListeners(ya, w);
                                        void 0 !== this.tabIndex && ya.setAttr("tabindex", this.tabIndex)
                                    }
                                    this.columnsSet.push(ya)
                                }
                            }
                            break;
                        case "candlestick":
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (Q < q && 0 < J) {
                                        var Eb, Fb;
                                        W > ta ? (Eb = [E, ra], Fb = [N, pa]) : (Eb = [N, ra], Fb = [E, pa]); ! isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Eb, [F, F], Ca, X, da), cb = d.line(h, Fb, [F, F], Ca, X, da));
                                        ba = E - N;
                                        ua = new d.Cuboid(h, ba, J, H, P, Na, Ya, da, Ca, X, ga, v, t, ea, bb, mb, aa)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    if (S < n && 0 < J) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, J, ba, H, P, Na, Va, da, Ca, X, ga, v, t, ea, bb, mb, aa),
                                            Gb,
                                            Hb;
                                        W > ta ? (Gb = [F, sa], Hb = [M, qa]) : (Gb = [M, sa], Hb = [F, qa]); ! isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Gb, Ca, X, da), cb = d.line(h, [E, E], Hb, Ca, X, da), d.setCN(a, Xa, this.bcn + "line-high"), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + "line-low"), w.className && d.setCN(a, cb, w.className, !0))
                                    }
                                }
                                ua && (ya = ua.set, w.columnGraphics = ya, fa.push(ya), ya.translate(S, Q - da / 2), (w.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (w.x = t ? Q + J / 2 : S + J / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(ya, w), void 0 !== this.tabIndex && ya.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
                            if (! (isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                ...
                                void 0 != w.lineColor && (Ha = w.lineColor);
                                var pb, qb, rb;
                                if (t) {
                                    la = F;
                                    ka = E;
                                    ...
                                    0 <= N && N <= oa && (qb = d.line(h, [N, N], [Ib, Tb], Ha, X, da, ea));
                                    0 < F && F < q && (pb = d.line(h, [pa, ra], [F, F], Ha, X, da, ea));
                                    0 <= E && E <= oa && (rb = d.line(h, [E, E], [Tb, Jb], Ha, X, da, ea))
                                } else {
                                    la = F;
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    0 <= M && M <= Fa && (qb = d.line(h, [Kb, Ub], [M, M], Ha, X, da, ea));
                                    0 < E && E < n && (pb = d.line(h, [E, E], [qa, sa], Ha, X, da, ea));
                                ...
                                w.className && d.setCN(a, Sb, w.className, !0);
                                xa = E;
                                Ea = F
                            }
                    }
                    if (!I && !isNaN(W)) {
                        ...
                        if (this.end - this.start <= Vb || 0 === Vb) {
                            var Wb = this.createBullet(w, ka, la, L),
                                Xb = this.labelText;
                            if (Xb && !isNaN(xa) && !isNaN(xa)) {
                                var gc = this.createLabel(w, Xb),
                                    Yb = 0;
                                Wb && (Yb = Wb.size);
                                this.positionLabel(w, xa, Ea, gc, Yb)
                            }
                            if ("regular" == O || "100%" == O) {
                                var Zb = f.totalText;
                                if (Zb) {
                                    var Oa = this.createLabel(w, Zb, f.totalTextColor);
                                    ...
                                    if (Oa) {
                                        ...
                                        t ? (eb = Ea, db = 0 > W ? E - ac / 2 - 2 - fb - sb: E + ac / 2 + 3 + fb + sb) : (db = xa, eb = 0 > W ? F + bc / 2 + fb + sb: F - bc / 2 - 3 - fb - sb);
                                        Oa.translate(db, eb);
                                        f.totals[L] = Oa;
            ...
            this.lastDataItem = w;
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T, U),
        ...
        createLabel: function(a, b, c) {
            ...
            f && (b = f(a, b));
            if (void 0 !== b && "" !== b) return a = d.text(this.container, b, h, e.fontFamily, c),
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                isNaN(r) && (r = q);
                var v = h.lineColorSwitched;
                v && (t = v);
                var v = h.fillColorsR,
                    y = h.fillColorsSwitched;
                y && (v = y);
                var x = h.dashLength; (y = h.dashLengthSwitched) && (x = y);
                ...
                void 0 === y || h.useNegativeColorIfDown || (p = d.line(l, a, b, y, r, p, x, !1, !0, f), p.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, p, h.bcn + "stroke"), d.setCN(k, p, h.bcn + "stroke-negative"), n.push(p));
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                var m = this.lineAlpha,
                    ...
                    v = this.negativeFillColors,
                    y = this.negativeFillAlphas,
                    x = this.baseCoord,
                    u = this.lineColorSwitched;
                u && (p = u); (u = this.fillColorsSwitched) && (t = u);
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + x + "," + b[b.length - 1], n += " L" + x + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + x, n += " L" + a[0] + "," + x), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, u), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), v || void 0 !== r) && (y || (y = q), v || (v = r), a = new d.Bezier(g, a, b, NaN, 0, 0, v, y, h, n, u), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
        ...
        createBullet: function(a, b, c) {
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                if (p) { (a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer");
                    if ("serial" == e.type || "gantt" == e.type) if ( - .5 > b || b > this.width || c < -g / 2 || c > this.height) p.remove(),
                        p = null;
                ...
                if (p) {
                    p.size = g || 0;
                    if (e = this.bulletHitAreaSize) h = d.circle(h, e, "#FFFFFF", .001, 0),
                        h.translate(b, c),
                        a.hitBullet = h,
        ...
        handleRollOut: function(a, b) {
            ...
            this.handleGraphEvent(b, "rollOutGraph"); (c = c.chartCursor) && c.valueBalloonsEnabled || this.hideBalloon()
        },
    ...
    d.ChartCursor = d.Class({
        ...
        showCursor: function(a) { ! this.drawing && this.enabled && (this.vLineEnabled && this.vvLine && this.vvLine.show(), this.hLineEnabled && this.hhLine && this.hhLine.show(), this.isHidden = !1, this.updateFullLine(), a || this.fire({
            target: this,
            chart: this.chart,
            type: "onShowCursor"
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        handleKeys: function(a, b, c) {
            ...
            if (this.rotate) var f = d,
                d = e,
                e = f;
            if (37 == a.keyCode || 40 == a.keyCode) e -= .02 * b,
                d -= .02 * c;
            if (39 == a.keyCode || 38 == a.keyCode) e += .02 * b,
                d += .02 * c;
        ...
        updateGripCursor: function(a) {
            d.isModern && (a = this.rotate ? a ? this.vResizeCursorDown: this.vResizeCursorHover: a ? this.hResizeCursorDown: this.hResizeCursorHover) && (this.iconRight && this.iconRight.node.setAttribute("style", a), this.iconLeft && this.iconLeft.node.setAttribute("style", a))
        },
                ...
                if ((m = a.graph) && a.catScrollbar) {
                    ...
                    for (t = 0; t < c.length; t++) {
                        var r = c[t].axes[p.id].graphs[m.id].values,
                            v;
                        for (v in r) if (r.hasOwnProperty(v) && "percents" != v && "total" != v) {
                            var y = r[v];
                            y < f && (f = y);
                            y > g && (g = y)
                        }
                    ...
                    v = a.unselectedGraph;
                    v.id = m.id;
                    v.bcn = "scrollbar-graph-";
                    v.rotate = h;
                    v.chart = b;
                    v.data = c;
                    v.valueAxis = q;
                    v.chart = m.chart;
                    v.categoryAxis = a.categoryAxis;
                    v.periodSpan = m.periodSpan;
                    v.valueField = m.valueField;
                    v.openField = m.openField;
                    v.closeField = m.closeField;
                    v.highField = m.highField;
                    v.lowField = m.lowField;
                    v.lineAlpha = a.graphLineAlpha;
                    v.lineColorR = a.graphLineColor;
                    v.fillAlphas = a.graphFillAlpha;
                    v.fillColorsR = a.graphFillColor;
                    v.connect = m.connect;
                    v.hidden = m.hidden;
                    v.width = k;
                    v.height = l;
                    v.pointPosition = m.pointPosition;
                    v.stepDirection = m.stepDirection;
                    v.periodSpan = m.periodSpan;
                    p = a.selectedGraph;
                    p.id = m.id;
                    p.bcn = v.bcn + "selected-";
                    p.rotate = h;
                    p.chart = b;
                    p.data = c;
                    p.valueAxis = q;
        ...
        dispatchScrollbarEvent: function() {
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this);
                ...
                if (k.parseDates && !k.equalSpacing) {
                    ...
                    h = k.xToIndex(b);
                    b = k.xToIndex(b + c);
                    if (h != this.start || this.end != b) k.startOnAxis && (this.resizingRight && h == b && b++, this.resizingLeft && h == b && (0 < h ? h--:b = 1)),
                        this.start = h,
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + C + "max-width:" + this.maxWidth + "px; font-size:" + z + "px; color:" + this.color + "; font-family:" + A + '">' + this.text + "</div>";
                    ...
                    A = H + 2 * v;
                    C = K + 2 * r; ! isNaN(D) && C < D && (C = D);
                    window.opera && (A += 2);
                    var P = !1,
                        z = this.offsetY;
                    c.handDrawn && (z += c.handDrawScatter + 2);
                    "H" != x ? (D = a - C / 2, b < k + A + 10 && "down" != x ? (P = !0, e && (b += z), z = b + y, this.deltaSignY = -1) : (e && (b -= z), z = b - A - y, this.deltaSignY = 1)) : (2 * y > A && (y = A / 2), z = b - A / 2, a < g + (l - g) / 2 ? (D = a + y, this.deltaSignX = -1) : (D = a - C - y, this.deltaSignX = 1));
                    z + A >= m && (z = m - A);
                    z < k && (z = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + v,
                        ...
                        I, v = this.fillAlpha,
                        aa = this.borderAlpha;
                    this.showBullet && (I = d.circle(h, ia, t, v), f.push(I));
                    this.drop ? (g = C / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (D = a + 1, z = b - g - g / 3), "up" == x && (l = 180, D = a + 1, z = b + g + g / 3), "left" == x && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == x && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - K / 2 - 1, q = d.drop(h, g, l, q, v, r, p, aa)) : 0 < u || 0 === y ? (0 < O && (a = d.rect(h, C, A, q, 0, r + 1, R, O, u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, v, r, p, aa, u)) : (t = [], u = [], "H" != x ? (g = a - D, g > C - y && (g = C - y), g < y && (g = y), t = [0, g - y, a - D, g + y, C, C, 0, 0], u = P ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (x = b - z, x > A - y && (x = A - y), x < y && (x = y), u = [0, x - y, b - z, x + y, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C: a - D, C, C, 0, 0, C]), 0 < O && (a = d.polygon(h, t, u, q, 0, r, R, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, u, q, v, r, p, aa));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            var t, r, v = {},
                y;
            k && (t = d.extractPeriod(m.minPeriod), r = t.period, t = t.count, y = d.getPeriodDuration(r, t));
            var x = {};
            this.lookupTable = x;
            ...
            for (u = b; u < c; u++) {
                ...
                for (K = 0; K < C.length; K++) {
                    ...
                    for (P = 0; P < h.length; P++) {
                        ...
                        var O = b.id,
                            R = 1.1;
                        isNaN(b.gapPeriod) || (R = b.gapPeriod);
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            var aa = D;
                            b.dataProvider && (aa = f);
                            I.values = this.processValues(aa, b, ia); ! b.connect && z && z[O] && 0 < R && B.time - v[O] >= y * R && (z[O].gap = !0);
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            ...
            t && !u && (isNaN(r) || (e = t.getCoordinate(r)), isNaN(v) || (h = t.getCoordinate(v)));
    ...
    d.polygon = function(a, b, c, e, h, f, g, k, l, m, n) {
        ...
        k = "M" + (g(b[0]) + n) + "," + (g(c[0]) + f);
        for (var t = 1; t < b.length; t++) m && (b[t] = d.roundTo(b[t], 5), c[t] = d.roundTo(c[t], 5)),
            k += " L" + (g(b[t]) + n) + "," + (g(c[t]) + f);
        a = a.path(k + " Z").attr(h);
    ...
    d.drop = function(a, b, c, d, h, f, g, k) {
        ...
        b = "M" + n + "," + q + " A" + b + "," + b + ",0,1,1," + p + "," + t + (" A" + r + "," + r + ",0,0,0," + (Math.sin((m + 20) * l) * b + y) + "," + (Math.cos((m + 20) * l) * b + v));
        b += " A" + r + "," + r + ",0,0,0," + n + "," + q;
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        var u = 1 / 180 * Math.PI,
            ...
            K = b + Math.sin((e + h) * u) * k,
            u = c - Math.cos((e + h) * u) * v,
            H = {
        ...
        e = a.set();
        var O;
        y && (x = r(10 * x), z = r(10 * z), D = r(10 * D), K = r(10 * K), A = r(10 * A), B = r(10 * B), C = r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, v *= 10, 1 > Math.abs(h) && 1 >= Math.abs(D - z) && 1 >= Math.abs(C - B) && (O = !0));
        h = "";
        var R;
        q && (H["fill-opacity"] = 0, H["stroke-opacity"] = m["stroke-opacity"] / 2, H.stroke = m.stroke);
        if (0 < l) {
            R = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
            y ? (O || (R += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + D + "," + (C + l)), R += " L" + K + "," + (u + l), 0 < k && (O || (R += " B" + (b - k) + "," + (l + c - v) + "," + (b + k) + "," + (l + c + v) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (R += " A" + f + "," + g + ",0," + P + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l), 0 < k && (R += " A" + k + "," + v + ",0," + P + ",0," + x + "," + (A + l)));
            R += " Z";
            var ia = l;
            y && (ia /= 10);
            for (var I = 0; I < ia; I += 10) {
                var aa = a.path(R, void 0, void 0, "1000,1000").attr(H);
                e.push(aa);
                aa.translate(0, -I)
            }
            R = a.path(" M" + x + "," + A + " L" + x + "," + (A + l) + " L" + z + "," + (B + l) + " L" + z + "," + B + " L" + x + "," + A + " Z", void 0, void 0, "1000,1000").attr(H);
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + K + "," + (u + l) + " L" + K + "," + u + " L" + D + "," + C + " Z", void 0, void 0, "1000,1000").attr(H);
            e.push(R);
            e.push(l)
        }
        y ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(B) + "," + r(D) + "," + r(C)), g = " M" + r(x) + "," + r(A) + " L" + r(z) + "," + r(B) + h + " L" + r(K) + "," + r(u)) : g = " M" + x + "," + A + " L" + z + "," + B + (" A" + f + "," + g + ",0," + P + ",1," + D + "," + C) + " L" + K + "," + u;
        0 < k && (y ? O || (g += " B" + (b - k) + "," + (c - v) + "," + (b + k) + "," + (c + v) + "," + K + "," + u + "," + x + "," + A) : g += " A" + k + "," + v + ",0," + P + ",0," + x + "," + A);
        a.handDrawn && (k = d.line(a, [x, z], [A, B], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
    ...
    d.adjustLuminosity = function(a, b) {
        ...
        var c = "#",
            e, h;
        for (h = 0; 3 > h; h++) e = parseInt(a.substr(2 * h, 2), 16),
    ...
    d.VMLRenderer = d.Class({
        ...
        gradient: function(a, b, c, d) {
            ...
            var f;
            for (f = 0; f < c.length; f++) h += Math.round(100 * f / (c.length - 1)) + "% " + c[f],
            f < c.length - 1 && (h += ",");
            a = a.fill;
    ...
    d.SVGRenderer = d.Class({
        ...
        update: function() {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                if (h <= e) {
                    ...
                    this.setAttr(f, g, c)
                } else "translate" == g ? (l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), f.translate(m, l)) : (k = Number(c.to), this.setAttr(f, g, k)),
        ...
        gradient: function(a, b, c, e) {
            ...
            for (e = 0; e < c.length; e++) g = document.createElementNS(d.SVG_NS, "stop"),
                k = 100 * e / (c.length - 1),
            0 === e && (k = 0),
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            this.titleWidth = 0;
            if (h = this.title) h = d.text(this.container, h, this.color, a.fontFamily, this.fontSize, "start", !0),
        ...
        arrangeEntries: function() {
            ...
            for (A = 0; A < x.length; A++) {
                ...
                K.translate(H, D);
                z++; ! isNaN(l) && z >= l && (z = 0, t++, D = D + C + m, B = f, C = 0);
                y.push(K)
            }
            u = y.getBBox();
            l = u.height + 2 * m - 1;
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                var k; ! 0 === a.hidden && (k = f = b.markerDisabledColor);
                var l = a.pattern,
                    m = a.customMarker;
                m || (m = b.customMarker);
                var n = b.container,
                ...
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) l = n.set(),
                    a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR),
                        p = d.line(n, [0, 2 * q], [q / 2, q / 2], f, a.lineAlpha, a.lineThickness, a.dashLength),
                        d.setCN(c, p, "graph-stroke"),
                        l.push(p),
                    a.bullet && (a.hidden || (f = a.bulletColorR), p = d.bullet(n, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, p, "graph-bullet"), p.translate(q + 1, q / 2), l.push(p)),
                        r = 0,
                        p = q,
                        t = q / 3;
                    else {
                        ...
                        p = a.fillColorsR; ! 0 === a.hidden && (p = f);
                        if (l = b.createMarker("rectangle", p, a.fillAlphas, a.lineThickness, f, a.lineAlpha, v, l, a.dashLength)) r = q,
                            l.translate(r, q / 2);
                        p = q
                    }
                    d.setCN(c, l, "graph-" + e);
                    ...
                    var y;
                    isNaN(b.gradientRotation) || (y = 180 + b.gradientRotation); (l = b.createMarker(h, f, g, void 0, void 0, void 0, y, l)) && l.translate(q / 2, q / 2)
                }
                ...
                k = b.switchType;
                var x;
                k && "none" != k && 0 < q && ("x" == k ? (x = b.createX(), x.translate(q / 2, q / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ? "x" == k ? x.hide() : x.show() : "x" != k && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, n.push(x), d.setCN(c, x, "legend-switch"));
                k = b.color;
                a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (k = b.selectedColor);
                b.useMarkerColorForLabels && (k = f); ! 0 === a.hidden && (k = b.markerDisabledColor);
                ...
                v = b.fontSize;
                l && (q <= v && (q = q / 2 + b.ly - v / 2 + (v + 2 - q) / 2 - t, l.translate(r, q), x && x.translate(x.x, q)), a.legendEntryWidth = l.getBBox().width);
                var u;
                f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, k, c.fontFamily, v, "start") : d.wrappedText(b.container, f, k, c.fontFamily, v, "start", !1, u, 0), d.setCN(c, u, "legend-label"), u.translate(b.lx + p, b.ly), n.push(u), b.labelDx = p, c = u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = n;
        ...
        createValue: function(a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    var g = b.color;
                    b.useMarkerColorForValues && (g = a.color, a.legendKeyColor && (g = a.legendKeyColor())); ! 0 === a.hidden && (g = b.markerDisabledColor);
                    var k = b.valueText,
            ...
            if (a) for (c = 0; c < a.length; c++) {
                ...
                if (e) f.value ? h.text(f.value) : h.text("");
                    ...
                    if (this.useMarkerColorForLabels) {
                        if (h = f.legendMarker) h.setAttr("fill", n),
                            h.setAttr("stroke", n); (f = f.legendLabel) && f.setAttr("fill", n)
                    }
                }
            }
        },
