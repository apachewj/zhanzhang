         ...
         for (var key in data) {
             ...
             if (eleType === 'text' || !eleType) {
                ...
                for (var i = 0; i < requires.length; i++) {
                    ...
                    }else if(2==data.maintype && 1 == data.isneed){
                                      ...
                                      '{@/if}',
                                        '<div class="item-title-row" >',
                                            ...
                                            '<div class="item-after">',
                                                    ...
                                                    '{@/if}',
                                                  '<span>','{@if item.price}','${item.price}','{@else if !item.price}', '0','{@/if}','</span>元<span>','{@if item.priceunit}','/${item.priceunit}','{@else if !item.priceunit}', '','{@/if}','</span>',
                                            '</div>',
                                        '</div>',
                                        '<div class="item-title-row">',
