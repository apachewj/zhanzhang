...
+ function($) {
    ...
    center.config = {
        ...
        qrcodeBackOrder:baseUrl + '/user/qrcodeBackOrder',
    ...
    $(function(){
        ...
        $(document).on("pageInit", function(e, pageId, $page) {
            ...
            }else if(pageId == "pageIndex")
            {
                ...
                qrcode.makeCode(+money+'&'+body+'&'+people+'&'+peopleid);
                ...
                setInterval(function(){
                    ...
                    //$('.finishgetmoney').show();
                    //var order_id = $("#out_trade_no_shoukuan").val();
                    //var pay_type = $("#app_type_shoukuan").val();

                    //var order_id = GetQueryString("out_trade_no");
                    ...
                    center.tool.ajax(center.config.qrcodeBackOrder, data, null, 'post', function(d) {
                        if (d.data == '支付成功') {
