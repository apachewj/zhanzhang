...
var region_init = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {
    ...
    function region_c_change() {
        ...
        for (var i = 0; i < item.district.length; i++) {
            option_items_add(region_d, item.district[i].name, item.district[i].name, null, i);
        }
    ...
    function region_p_change() {
        ...
        for (var i = 0; i < item.city.length; i++) {
            option_items_add(region_c, item.city[i].name, item.city[i].name, item.city[i], i);
        }
    ...
    for (var i = 0; i < province_enum.length; i++) {
        option_items_add(region_p, province_enum[i].name, province_enum[i].name, province_enum[i]);
    }
