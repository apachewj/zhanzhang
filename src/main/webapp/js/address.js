...
function _cityPosdata(obj){
         for (var i = 0; i < province_enum.length; i++) {
            if (province_enum[i].name === obj ){
           cityPosdatas[0]=province_enum[i].id;
            cityPosdatas[1]=province_enum[i].name;
        }
            for(var j = 0; j < province_enum[i].city.length; j++) {

            if ( province_enum[i].city[j].name === obj){
        ...
        if (window.tourism==window.filedate){
               ...
               filedate.index.query(cityPosdatas[0]);
        }else if(window.speciality==window.filedate){ 
               filedate.localmessage.detail(mpid,cityPosdatas[0]);
        }else if(window.love == window.filedate){ 
               filedate.index.query(cityPosdatas[0]); 
         }else if(window.notice==window.filedate){ 
                filedate.index.query(cityPosdatas[0]);
        } 
...
var region_init = function (_region_p, _region_c, _region_d, _region_p_default, _region_c_default, _region_d_default) {
    ...
    function region_c_change() {
        ...
        if (window.tourism==window.filedate){
               ...
               filedate.localmessage.detail(mpid);
        }else if(window.love==window.filedate){ 
                filedate.index.query(); 
        }else if(window.notice==window.filedate){ 
                filedate.index.query();
